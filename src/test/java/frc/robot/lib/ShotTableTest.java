...
public class ShotTableTest {
  ...
  public void returnsInsertedShooterData() {
    ...
    table.put(Meters.of(2.0), Degrees.of(40.0), RotationsPerSecond.of(15.0), Seconds.of(0.6));
  ...
  public void interpolatesBetweenPoints() {
    ShotTable table = new ShotTable();
    table.put(Meters.of(1.0), Degrees.of(30.0), RotationsPerSecond.of(10.0), Seconds.of(0.4));
    table.put(Meters.of(3.0), Degrees.of(50.0), RotationsPerSecond.of(20.0), Seconds.of(0.8));
