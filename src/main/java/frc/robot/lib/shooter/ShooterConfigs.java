...
public class ShooterConfigs {
  ...
  private static ExitSpeedTable rightExitSpeedTable() {
    ...
    table.put(MetersPerSecond.of(7.94416), RotationsPerSecond.of(55.07813 + 2.0 + 1.0));
    table.put(MetersPerSecond.of(8.60935), RotationsPerSecond.of(60.93750 + 2.0 + 1.0));
    table.put(MetersPerSecond.of(13.0), RotationsPerSecond.of(89.3950053912 + 1.0));
