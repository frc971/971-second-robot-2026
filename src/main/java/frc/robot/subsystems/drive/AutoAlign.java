...
public class AutoAlign {
  ...
  public void updateDashboard() {
    ...
    if (angleToTarget != null) Logger.recordOutput("Drive/AutoAlign/AngleToTarget", angleToTarget);

    if (currentPose != null) Logger.recordOutput("Drive/AutoAlign/Current Pose", currentPose);

    if (targetPose != null) Logger.recordOutput("Drive/AutoAlign/Target Pose", targetPose);
  }
}
