    ...
    private void configureDrivetrain() {
        ...
        drivetrain.setDefaultCommand(
                drivetrain.applyRequest(
                        () -> {
                            boolean wantsDrive = Math.abs(Controllers.DRIVER.getLeftY()) > TRANSLATION_DEADBAND
        ...
        Controllers.DRIVER.b()
                .onTrue(Commands.runOnce(() -> drivetrain.resetPose(new Pose2d(8.0, 4.0, Rotation2d.kZero))));
        drivetrain.registerTelemetry(logger::telemeterize);
    }
