...
public class Telemetry {
  ...
  private final FieldObject2d autoStartPose;
  ...
  public Telemetry(double maxSpeed) {
    ...
    autoStartPose = field.getObject("AutoStartPose");
    robotPose = field.getObject("RobotPose");
  ...
  /**
   * Set the autonomous starting pose on the field visualization
   *
   * @param pose The autonomous starting pose, or null to hide it
   */
  public void setAutoStartPose(Pose2d pose) {
    if (pose != null) {
      autoStartPose.setPose(pose);
    }
  }
}
